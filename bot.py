...
class TronLotteryBot:
    ...
    def run(self):
        ...
        # افزودن هندلرها / Add handlers - دقیقاً مثل فایل اول
        ...
        # هندلرهای دکمه‌ها / Button handlers - دقیقاً مثل فایل اول
        ...
        # هندلرهای پنل ادمین / Admin panel handlers - دقیقاً مثل فایل اول
        ...
        # هندلر متن / Text handler - دقیقاً مثل فایل اول
