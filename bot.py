"""
ربات لاتاری TRON - نسخه نهایی حرفه‌ای با سیستم قرعه‌کشی
TRON Lottery Bot - Final Professional Version with Lottery System
"""
...
# ==================== تنظیمات کدبندی / Encoding Configuration ====================
# حل مشکل encoding
...
class DatabaseManager:
    ...
    def ensure_data_directory(self):
        ...
        try:
            ...
            if not os.path.exists('exports'):
                os.makedirs('exports')
            print("✅ پوشه‌های داده ایجاد شدند / Data directories created")
        except Exception as e:
            print(f"⚠️ خطا در ایجاد پوشه‌ها: {e} / Error creating directories: {e}")
    ...
    def init_database(self):
        ...
        try:
            ...
            print("✅ دیتابیس با موفقیت ایجاد شد / Database created successfully")
            
            # ایجاد پشتیبان اولیه / Create initial backup
            self.create_backup()
            
        except Exception as e:
            print(f"❌ خطا در ایجاد دیتابیس: {e} / Error creating database: {e}")
    ...
    def create_backup(self):
        ...
        try:
            ...
            if os.path.exists(self.db_name):
                ...
                print(f"✅ پشتیبان ایجاد شد: {backup_file} / Backup created: {backup_file}")
                return True
            else:
                print("⚠️ فایل دیتابیس اصلی وجود ندارد / Main database file doesn't exist")
                return False
        except Exception as e:
            print(f"⚠️ خطا در ایجاد پشتیبان: {e} / Backup failed: {e}")
            return False
    ...
    def create_user(self, user_id: int, username: str, first_name: str, referred_by: int = None):
        ...
        try:
            ...
            if referred_by:
                ...
                print(f"✅ رفرال ثبت شد: {referred_by} -> {user_id} / Referral recorded")
                
        except Exception as e:
            print(f"❌ خطا در ایجاد کاربر: {e} / Error creating user: {e}")
        finally:
            conn.close()
    ...
    def update_user_language(self, user_id: int, language: str):
        ...
        try:
            ...
            print(f"خطا در بروزرسانی زبان: {e}")
    ...
    def update_user_activity(self, user_id: int):
        ...
        try:
            ...
            print(f"خطا در بروزرسانی فعالیت: {e}")
    ...
    def mark_user_as_paid(self, user_id: int):
        ...
        try:
            ...
            print(f"خطا در علامت‌گذاری پرداخت: {e}")
    ...
    def add_referral(self, referrer_id: int, referred_id: int):
        ...
        try:
            ...
            # بررسی اینکه آیا رفرال از قبل وجود دارد
            ...
            if not existing_referral:
                ...
                conn.commit()
                print(f"✅ رفرال اضافه شد: {referrer_id} -> {referred_id}")
            else:
                print(f"⚠️ رفرال از قبل وجود دارد: {referred_id}")
                
        except Exception as e:
            print(f"❌ خطا در اضافه کردن رفرال: {e}")
        finally:
            conn.close()
    ...
    def create_lottery_ticket(self, user_id: int) -> str:
        ...
        try:
            ...
            print(f"خطا در ایجاد بلیط: {e}")
            return f"T{user_id}T{int(datetime.now().timestamp())}ERR"
    ...
    def get_eligible_users(self) -> List[Dict]:
        ...
        try:
            ...
            print(f"خطا در دریافت کاربران واجد شرایط: {e}")
            return []
    ...
    def get_all_users(self) -> List[Dict]:
        ...
        try:
            ...
            print(f"خطا در دریافت تمام کاربران: {e}")
            return []
    ...
    def get_pending_payments(self) -> List[Dict]:
        ...
        try:
            ...
            print(f"خطا در دریافت پرداخت‌های در انتظار: {e}")
            return []
    ...
    def approve_payment(self, payment_id: int):
        ...
        try:
            ...
            conn.commit()
            conn.close()
            print(f"✅ پرداخت تأیید شد: {payment_id}")
        except Exception as e:
    ...
    def export_users_to_txt(self):
        ...
        try:
            ...
            print(f"خطا در خروجی کاربران: {e}")
            return None
    ...
    def export_winners_to_txt(self):
        ...
        try:
            ...
            print(f"خطا در خروجی برندگان: {e}")
            return None
    ...
    def mark_message_as_read(self, message_id: int):
        ...
        try:
            ...
            print(f"خطا در علامت‌گذاری پیام: {e}")
    ...
    def create_lottery_draw(self, draw_date: datetime) -> int:
        ...
        try:
            ...
            print(f"خطا در ایجاد قرعه‌کشی: {e}")
            return 0
    ...
    def get_scheduled_draws(self) -> List[Dict]:
        ...
        try:
            ...
            print(f"خطا در دریافت قرعه‌کشی‌ها: {e}")
            return []
    ...
    def get_all_winners(self) -> List[Dict]:
        ...
        try:
            ...
            print(f"خطا در دریافت برندگان: {e}")
            return []
    ...
    def declare_winners(self, draw_id: int, winners: List[Dict]):
        ...
        try:
            ...
            conn.commit()
            conn.close()
            print(f"✅ برندگان اعلام شدند: {len(winners)} برنده")
        except Exception as e:
            print(f"خطا در اعلام برندگان: {e}")
    ...
    def update_winner_wallet(self, user_id: int, wallet_address: str):
        ...
        try:
            ...
            print(f"خطا در بروزرسانی آدرس کیف پول: {e}")
    ...
    def mark_winner_as_paid(self, winner_id: int):
        ...
        try:
            ...
            print(f"خطا در علامت‌گذاری برنده: {e}")
...
class AutoVerificationSystem:
    ...
    async def start_auto_verification(self, application):
        ...
        while self.is_running:
            try:
                ...
                print(f"⚠️ خطا در تأیید خودکار: {e}")
    ...
    async def check_recent_transactions(self, application):
        ...
        try:
            ...
            print(f"⚠️ خطا در بررسی تراکنش‌ها: {e}")
    ...
    async def process_transaction(self, tx_data, application):
        ...
        try:
            ...
            print(f"🔍 تراکنش جدید شناسایی شد: {transaction_hash} - ${amount_usd:.2f}")
...
class TronLotteryBot:
    ...
    async def start(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        # رفع مشکل رفرال - بررسی آرگومان‌ها به درستی
        referred_by = None
        if context.args and len(context.args) > 0:
            referral_code = context.args[0]
            referred_by = self._get_user_id_by_referral_code(referral_code)
            print(f"👥 کاربر {user.id} از طریق کد رفرال آمده: {referral_code} از کاربر: {referred_by}")
        
        # ایجاد کاربر جدید یا به‌روزرسانی اطلاعات
        existing_user = self.db.get_user(user.id)
        if not existing_user:
            self.db.create_user(user.id, user.username, user.first_name, referred_by)
            print(f"✅ کاربر جدید ایجاد شد: {user.id} با رفرال: {referred_by}")
        elif referred_by and not existing_user['referred_by']:
            # اگر کاربر موجود است اما رفرال ندارد، آن را اضافه کن
            self.db.add_referral(referred_by, user.id)
            print(f"✅ رفرال به کاربر موجود اضافه شد: {user.id} از: {referred_by}")
    ...
    async def show_main_menu(self, update: Update, language: str, user=None):
        ...
        keyboard = [
            [KeyboardButton(self.lang.get_text(language, 'start_button'))],
        ...
        # اگر از طریق deep link آمده، پیام خوشامدگویی بفرست
        if update.message:
            await update.message.reply_text(welcome_text, reply_markup=reply_markup)
        else:
            # برای callback queries
            await update.callback_query.message.reply_text(welcome_text, reply_markup=reply_markup)
    
    async def handle_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        """مدیریت تمام پیام‌ها / Handle all messages"""
        user = update.effective_user
        message_text = update.message.text
        
        print(f"📨 پیام دریافت شد از {user.id}: {message_text}")
        
        # اگر پیام "شروع" یا "Start" است، دستور start را اجرا کن
        if message_text in ["شروع", "Start", "/start", "استارت", "🚀 شروع", "🚀 Start"]:
            await self.start(update, context)
            return
        
        # مدیریت سایر پیام‌ها
        await self.handle_transaction(update, context)
    ...
    async def show_admin_panel(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        keyboard = [
            ...
            [KeyboardButton(self.lang.get_text(language, 'start_lottery')),
             KeyboardButton(self.lang.get_text(language, 'winners_list'))],
            [KeyboardButton(self.lang.get_text(language, 'set_draw_date')),
             KeyboardButton(self.lang.get_text(language, 'lottery_stats'))],
            [KeyboardButton(self.lang.get_text(language, 'back'))]
        ]
        reply_markup = ReplyKeyboardMarkup(keyboard, resize_keyboard=True)
    ...
    async def handle_users_list(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        # ایجاد فایل TXT
        filename = self.db.export_users_to_txt()
        ...
        if filename:
            ...
            with open(filename, 'rb') as file:
                await update.message.reply_document(
                    ...
                    caption="📊 لیست کامل کاربران به صورت TXT"
                )
        else:
            await update.message.reply_text("❌ خطا در ایجاد فایل خروجی")
    
    async def handle_winners_list(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        """لیست برندگان / Winners list"""
        user = update.effective_user
        language = self.get_user_language(user.id)
        ...
        # ایجاد فایل TXT
        filename = self.db.export_winners_to_txt()
        ...
        if filename:
            ...
            with open(filename, 'rb') as file:
                await update.message.reply_document(
                    document=file,
                    filename=os.path.basename(filename),
                    caption="🏆 لیست کامل برندگان به صورت TXT"
                )
        else:
            await update.message.reply_text("❌ خطا در ایجاد فایل خروجی")
    ...
    async def handle_user_stats(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        stats_text = (
            ...
            f"💳 کاربران پرداخت کننده: {stats['paid_users']}"
        )
    ...
    async def handle_start_lottery(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        """شروع قرعه‌کشی / Start lottery"""
        user = update.effective_user
        language = self.get_user_language(user.id)
        ...
        await update.message.reply_text(self.lang.get_text(language, 'lottery_in_progress'))
        
        # انتخاب برندگان
        winners = self.lottery_system.select_winners()
        
        if not winners:
            await update.message.reply_text(self.lang.get_text(language, 'no_eligible_users'))
            return
        
        # ایجاد قرعه‌کشی جدید
        draw_id = self.db.create_lottery_draw(datetime.now())
        
        # ثبت برندگان
        self.db.declare_winners(draw_id, winners)
        
        # ارسال پیام به ادمین
        winners_list = "\n".join([
            f"🏆 {i+1}. {winner['first_name']} (@{winner['username']}) - ${winner['prize_amount']}"
            for i, winner in enumerate(winners)
        ])
        
        total_prize = sum(winner['prize_amount'] for winner in winners)
        
        admin_message = self.lang.get_text(language, 'lottery_winners_announcement').format(
            winners_list=winners_list,
            total_prize=total_prize
        )
        
        await update.message.reply_text(admin_message)
        await update.message.reply_text(self.lang.get_text(language, 'lottery_complete'))
        
        # ارسال پیام به برندگان پس از 5 دقیقه
        asyncio.create_task(self.announce_winners_after_delay(winners, context))
    
    async def announce_winners_after_delay(self, winners: List[Dict], context: ContextTypes.DEFAULT_TYPE):
        """اعلام برندگان پس از تاخیر / Announce winners after delay"""
        await asyncio.sleep(300)  # 5 دقیقه
        
        for winner in winners:
            await self.announce_winner(winner, context)
    
    async def announce_winner(self, winner: Dict, context: ContextTypes.DEFAULT_TYPE):
        """اعلام برنده به کاربر / Announce winner to user"""
        try:
            user_language = self.get_user_language(winner['user_id'])
            winner_message = self.lang.get_text(user_language, 'congratulations_winner').format(amount=winner['prize_amount'])
            ...
            print(f"✅ برنده اعلام شد به کاربر {winner['user_id']} با جایزه ${winner['prize_amount']}")
            
        except Exception as e:
            print(f"❌ خطا در اعلام برنده به {winner['user_id']}: {e}")
    
    async def handle_set_draw_date(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        """تنظیم تاریخ قرعه‌کشی / Set draw date"""
        user = update.effective_user
        language = self.get_user_language(user.id)
        ...
        context.user_data['awaiting_draw_date'] = True
        await update.message.reply_text(self.lang.get_text(language, 'enter_draw_date'))
    
    async def handle_lottery_stats(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        """آمار قرعه‌کشی / Lottery statistics"""
        user = update.effective_user
        language = self.get_user_language(user.id)
        ...
        scheduled_draws = self.db.get_scheduled_draws()
        
        total_prizes = sum(winner['prize_amount'] for winner in winners)
        
        stats_text = (
            f"{self.lang.get_text(language, 'lottery_stats')}\n\n"
            f"{self.lang.get_text(language, 'total_winners').format(count=len(winners))}\n"
            f"{self.lang.get_text(language, 'total_prizes').format(amount=total_prizes)}\n"
        )
        
        if scheduled_draws:
            next_draw = scheduled_draws[0]
            stats_text += f"{self.lang.get_text(language, 'next_draw').format(date=next_draw['draw_date'])}"
        else:
            stats_text += f"{self.lang.get_text(language, 'no_draw_scheduled')}"
    ...
    async def handle_transaction(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        ...
        # بررسی اگر در حالت انتظار برای تاریخ قرعه‌کشی هستیم
        if 'awaiting_draw_date' in context.user_data and context.user_data['awaiting_draw_date']:
            context.user_data['awaiting_draw_date'] = False
            try:
                draw_date = datetime.strptime(message_text, '%Y-%m-%d %H:%M')
                self.db.create_lottery_draw(draw_date)
                await update.message.reply_text(self.lang.get_text(language, 'draw_date_set').format(date=draw_date))
                return
            except ValueError:
                await update.message.reply_text(self.lang.get_text(language, 'invalid_date_format'))
                return
        ...
        if self.is_admin(user.id):
            if message_text == self.lang.get_text(language, 'admin_panel'):
                ...
                return
            elif message_text == self.lang.get_text(language, 'start_lottery'):
                await self.handle_start_lottery(update, context)
                return
            elif message_text == self.lang.get_text(language, 'winners_list'):
                await self.handle_winners_list(update, context)
                return
            elif message_text == self.lang.get_text(language, 'set_draw_date'):
                await self.handle_set_draw_date(update, context)
                return
            elif message_text == self.lang.get_text(language, 'lottery_stats'):
                await self.handle_lottery_stats(update, context)
                return
    ...
    async def send_broadcast_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE, message: str):
        ...
        for user_data in users:
            try:
                ...
                failed += 1
                print(f"❌ خطا در ارسال پیام به {user_data['user_id']}: {e}")
    ...
    def run(self):
        ...
        # هندلر اصلی برای تمام پیام‌ها - رفع مشکل استارت خودکار
        ...
        application.add_handler(MessageHandler(filters.Regex("🚀 شروع|🚀 Start"), self.start))
        ...
        application.add_handler(MessageHandler(filters.Regex("🎰 شروع قرعه‌کشی|🎰 Start Lottery Draw"), self.handle_start_lottery))
        application.add_handler(MessageHandler(filters.Regex("🏆 لیست برندگان|🏆 Winners List"), self.handle_winners_list))
        application.add_handler(MessageHandler(filters.Regex("📅 تنظیم تاریخ قرعه‌کشی|📅 Set Draw Date"), self.handle_set_draw_date))
        application.add_handler(MessageHandler(filters.Regex("📊 آمار قرعه‌کشی|📊 Lottery Statistics"), self.handle_lottery_stats))
        ...
        print("🔗 سیستم رفرال کاملاً اصلاح شد / Referral system completely fixed")
        print("💾 سیستم کدبندی UTF-8 فعال شد / UTF-8 encoding system activated")
        print("🚀 سیستم استارت خودکار فعال شد / Auto start system activated")
...
if __name__ == "__main__":
    print("🚀 ربات لاتاری TRON - نسخه نهایی حرفه‌ای / TRON Lottery Bot - Final Professional Version")
    print("=" * 70)
    ...
    if Config.BOT_TOKEN == "توکن_ربات_خودت_را_اینجا_قرار_ده":
        ...
        print("\n💡 **ویژگی‌های جدید:**")
        print("✅ **استارت خودکار:** کاربران نیازی به تایپ /start ندارند")
        print("✅ **رفرال کامل:** سیستم رفرال کاملاً کار می‌کند")
        print("✅ **کدبندی UTF-8:** مشکل encoding حل شده")
        print("✅ **بکاپ ایمن:** سیستم بکاپ بدون خطا")
